...
--- | --- | ---
v1.7.1 | v1.7.2 | [link](UPGRADE.md#v171--v172)
...
export CHART_VERSION=1.7.2            # a chart version: https://github.com/odenio/pgpool-cloudsql/releases
...
`deploy.tag` | If set, override the tag of the runtime container image. If left empty, we use the concatenation of the chart version (`1.7.2`) and the selected `pgpool.version` e.g. `1.7.2-4.5.12` | `""`
