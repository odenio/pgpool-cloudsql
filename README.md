...
export CHART_VERSION=1.0.7            # a chart version: https://github.com/odenio/pgpool-cloudsql/releases
...
`deploy.tag` | Docker image tag of the runtime image | `1.0.7`
`deploy.service.tier` | Value for the "tier" [label](https://kubernetes.io/docs/concepts/overview/working-with-objects/labels/) applied to the kubernetes [service](https://kubernetes.io/docs/concepts/services-networking/service/) | `1.0.7`
